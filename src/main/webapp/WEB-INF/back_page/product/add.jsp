...
.h2_ch a {
    ...
    background: url('/res/togogo/img/admin/bg_ch.gif') repeat-x scroll 0% 0% transparent;
}
a {
    color: #06C;
...
$(function(){
	...
	$("#pic").change(function() {
		...
		dataURL = $file.val();
		var imgObj = document.getElementById("product_url");
		// 两个坑:
...
function uploadPic(){
	...
	var options = {
		...
		success:function(data){
			...
			//$("#product_url").attr("src",data.imgUrl);
